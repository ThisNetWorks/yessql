...
namespace YesSql.Core.QueryParser.Builders
{
    public static class TermParserBuilderExtensions
    {
        ...
        public static UnaryParserBuilder<T> OneCondition<T>(this TermParserBuilder<T> builder, Func<string, IQuery<T>, QueryExecutionContext<T>, ValueTask<IQuery<T>>> matchQuery) where T : class
        {
